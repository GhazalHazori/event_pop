...
class ExploreViewController extends BaseControoler {
  ...
  List<CategoryModel> intrestList = [
    CategoryModel(id: 1, name: "Sports", logo: "sports"),
    CategoryModel(id: 2, name: "Arts", logo: "arts"),
    CategoryModel(id: 3, name: "Music", logo: "music")
  ];
  ...
  List<CategoryModel> intrestListFilter = [
    CategoryModel(id: 1, name: "Sports", logo: "sports"),
    CategoryModel(id: 2, name: "Arts", logo: "arts"),
    CategoryModel(id: 3, name: "Music", logo: "music")
  ];
  ...
  RxList<NearlyEventmodel> nearlyevent = <NearlyEventmodel>[].obs;
  Future<void> getUpComingEvent() async {
    runLoadingFutureFunction(
        type: OperationType.UPCOMING,
        function: EventRepository().getUpComingEvent().then((value) {
          value.fold((l) {
  ...
  Future<void> getNearluEvent() async {
    runLoadingFutureFunction(
        type: OperationType.UPCOMING,
        function: EventRepository().getNearlyEvent().then((value) {
          value.fold((l) {
            // CustomToast.showMessage(
            //     message: l, messagetype: MessagType.REJECTED);
          }, (r) {
