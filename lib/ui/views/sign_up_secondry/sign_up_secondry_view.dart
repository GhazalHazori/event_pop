...
class SignUpSecondryView extends StatefulWidget {
  const SignUpSecondryView({super.key, required this.name, required this.password,required this.phoneNumber, required this.email});
final String name;
...
final String email;
  ...
  @override
  State<SignUpSecondryView> createState() => _SignUpSecondryViewState();
}

class _SignUpSecondryViewState extends State<SignUpSecondryView>
  ...
  @override
  void initState() {
    controller = Get.put(SignUpSecondaryViewController(widget.name,widget.password,widget.phoneNumber,widget.email));
                ...
                onChanged: (String? newValue) {
                  // لا حاجة لتنفيذ إجراء هنا للاختيار المتعدد
                                ...
                                CustomMainButton(text: "Sign Up", onpressed: (){
                                  controller.register(email: widget.email, password: widget.password, phoneNumber: widget.phoneNumber, name: widget.name, provinces: controller.selectedLocations, interests: controller.selectedInterests.value);
